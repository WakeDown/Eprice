...
namespace EPriceRequestServiceDBEngine
{
    public class DbEngine
    {
        ...
        public List<Un1tProductBase> SaveProducts(List<Un1tProductBase> products, ProviderType provider)
        {
            ...
            if (products.Any())
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    foreach (var product in products.Where(x=>!string.IsNullOrEmpty(x.PartNumber)).ToList())
                    {
        ...
        public void SaveProductsProperties(List<Un1tProductBase> products, ProviderType provider)
        {
            if (products.Any())
            {
                using (var conn = new SqlConnection(_connectionString))
